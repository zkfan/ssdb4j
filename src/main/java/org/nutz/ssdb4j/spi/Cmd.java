...
public class Cmd {
	...
	public static final Cmd scan = new Cmd("scan", true, false);
	public static final Cmd rscan = new Cmd("rscan", true, false);
	...
	public static final Cmd hlist = new Cmd("hlist", true, true);
	public static final Cmd hincr = new Cmd("hincr", true, true);
	public static final Cmd hscan = new Cmd("hscan", true, true);
	public static final Cmd hrscan = new Cmd("hrscan", true, true);
	...
	public static final Cmd zscan = new Cmd("zscan", true, true);
	public static final Cmd zrscan = new Cmd("zrscan", true, true);
	public static final Cmd zrange = new Cmd("zrange", true, true);
	public static final Cmd zrrange = new Cmd("zrrange", true, true);
...
//	public static final Cmd exec = new Cmd("exec", false, true);
	...
	public static final Cmd hgetall          =  new Cmd("hgetall"        , true, false);
